...
/* ── Month in Focus ───────────────────────────────────────── */
.f-month{font-size:1.45rem;font-weight:800;color:#00e8c4;margin-bottom:2px}
/* Section dividers — very dim */
.f-section{font-size:.56rem;color:#7d8590;text-transform:uppercase;letter-spacing:.1em;
           margin-top:2px;margin-bottom:1px;border-top:1px solid #21262d;padding-top:2px}
.f-row{display:flex;justify-content:space-between;align-items:baseline;margin-bottom:1px}
/* Labels readable but clearly secondary to data values */
.f-label{font-size:.7rem;color:#8b949e}
.f-val{font-size:.9rem;color:#f0f6fc;font-weight:700}
.f-grid{display:grid;grid-template-columns:1fr auto auto;gap:1px 14px;align-items:baseline;margin-bottom:1px}
.f-col-hdr{font-size:.54rem;color:#4e5866;text-transform:uppercase;text-align:right}
/* Big % number — hero element */
.f-pct{font-size:1.7rem;font-weight:900;line-height:1;margin:2px 0}
.f-bar{height:6px;background:#21262d;border-radius:4px;margin:2px 0}
.f-bar-fill{height:100%;border-radius:4px;transition:width .6s}
.f-days{font-size:.6rem;color:#8b949e;margin-bottom:2px}
.f-pace{font-size:.75rem;font-weight:700;padding:3px 10px;border-radius:12px;display:inline-block}
