...
/* Current month panel — big readable numbers */
#pnl-cur{justify-content:center}
#pnl-cur table{font-size:1.15rem}
#pnl-cur th{font-size:.65rem;padding:4px 10px}
#pnl-cur td{padding:8px 10px;font-size:1.15rem;border-bottom:1px solid #21262d}
#pnl-cur .num{font-size:1.35rem;font-weight:800}
#pnl-cur .val{font-size:1.25rem;font-weight:700}
#pnl-cur .ch-dot{width:10px;height:10px;margin-right:8px}
#pnl-cur tr.grand-total td{font-size:1.3rem;padding:10px 10px}
